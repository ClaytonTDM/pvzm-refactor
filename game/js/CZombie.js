var CZombies = (function (b, a) {
      ...
      ((a = function () {}).prototype = {
        ...
        ChangeR: function (e) {
          var h = e.R,
            ...
            c;
          !g.length &&
            (d.CanPass(q, i[q]) && (g[++m] = q), d.CanPass((q += 2), i[q]) && (g[++m] = q));
          g.length
        ...
        Init: function (g, i, e, d) {
          var c = 0,
            ...
            f = [];
          i.AttackedRX =
            (i.X = (i.ZX = i.AttackedLX = g) - i.beAttackedPointL) + i.beAttackedPointR;
          while (--d) {
          ...
          c &&
            oSym.addTask(
              ...
              function (j, i) {
                ...
                k &&
                  k.FreeSlowTime == i &&
                  ((k.FreeSlowTime = 0), (k.Attack = 100), k.Speed && (k.Speed = k.OSpeed));
              },
              [f, d]
            );
        },
        ...
        JudgeAttack: function () {
          ...
          (c = g.JudgeLR(g, e, f, d, h) || g.JudgeSR(g, e, f, d, h))
            ? (!g.isAttacking && ((g.isAttacking = 1), (g.EleBody.src = g.PicArr[g.AttackGif])),
        ...
        e < b &&
          ...
          oSym.addTask(
            ...
            function (h, d) {
              ...
              i &&
                i.FreeSlowTime == d &&
                ((i.FreeSlowTime = 0), (i.Attack = 100), i.Speed && (i.Speed = i.OSpeed));
            },
            [f.id, b]
          ));
        f.getHit0(f, c, g);
                    ...
                    (q = m[r]) &&
                      ...
                      n.push(
                        NewImg(
                          '',
                          k,
                          'z-index:' + q[3] + ';left:' + q[4](v) + 'px;top:' + q[5] + 'px',
                          EDPZ
                        )
                      ),
                      ++o);
  ...
  OrnIZombies = (function () {
    var a = function (f, b) {
      ...
      (d = f.OrnHP -= b) < 1 &&
        ...
        (f.EleBody.src =
          f.PicArr[
            [(f.NormalGif = f.OrnLostNormalGif), (f.AttackGif = f.OrnLostAttackGif)][f.isAttacking]
          ]),
  ...
  oPoleVaultingZombie = InheritO(OrnNoneZombies, {
    ...
    NormalAttack: function (d, b, g) {
      var f = $Z[d],
        ...
        e = f.EleBody;
      e.src =
        'images/Zombies/PoleVaultingZombie/PoleVaultingZombieJump.gif' + $Random + Math.random();
      PlayAudio('grassstep');
      SetHidden(c);
      f.isAttacking = 1;
      f.Altitude = 2;
      ...
      oSym.addTask(
        ...
        function (m, j, i, l, n) {
          ...
          h &&
            ((k = $P[j]) && k.Stature > 0
              ? ((h.AttackedRX =
                  (h.X = (h.AttackedLX = h.ZX = q = k.AttackedRX) - h.beAttackedPointL) +
                  h.beAttackedPointR),
              ...
              : ((h.ZX = h.AttackedLX =
                  (h.X = (h.AttackedRX = g) - h.beAttackedPointR) + h.beAttackedPointL),
                SetStyle(i, { left: h.X + 'px' }),
                (n.src =
  ...
  oScreenDoorZombie = InheritO(oNewspaperZombie, {
    ...
    CheckOrnHP: function (g, h, d, c, f, b, a) {
      ...
      (g.OrnHP = d -= c) < 1 &&
        ...
        (g.Ornaments = 0),
        (g.EleBody.src =
          f[[(g.NormalGif = g.OrnLostNormalGif), (g.AttackGif = g.OrnLostAttackGif)][b]]),
        (g.LostHeadGif = 8),
        (g.LostHeadAttackGif = 9),
        (g.getPea = e.getPea),
        (g.getFirePea = e.getFirePea),
  ...
  oAquaticZombie = InheritO(OrnNoneZombies, {
    ...
    ExchangeLR: function (d, b) {
      ...
      d.EleShadow.style.cssText =
        'visibility:hidden;left:' + (d.beAttackedPointL - 10) + 'px;top:' + (d.height - 22) + 'px';
                        ...
                        : ((k.EleBody.src = k.PicArr[10] + Math.random()),
                          ...
                          oSym.addTask(
                            ...
                            function (l, m) {
                              $Z[l] &&
                                m.beAttacked &&
                                ((m.isAttacking = 0), (m.EleBody.src = m.PicArr[m.NormalGif]));
                            },
                            [i, k]
                          )));
                  },
  ...
  oSmallSnorkelZombie = InheritO(oSnorkelZombie, {
    ...
    getShadow: function (a) {
      return (
        'width:43px;height:18px;left:' + a.beAttackedPointL + 'px;top:' + (a.height - 45) + 'px'
      );
    },
  }),
  oZomboni = (function () {
      ...
      oSym.addTask(
        ...
        function (m, j, i, l, q) {
          ...
          h &&
            ((k = $P[j]) && k.Stature > 0
              ? ((h.AttackedRX =
                  (h.X = (h.AttackedLX = h.ZX = r = k.AttackedRX) - (h.beAttackedPointL = 45)) +
                  ...
                  g.length
                    ? ((l = !d.WalkDirection ? -5 : 5),
                      ...
                      SetStyle(f, {
                        left: d.X + 'px',
                        top:
                          (d.pixelTop = j == undefined ? GetY(q) - d.height + d.GetDY() : j) + 'px',
                        zIndex: (d.zIndex = 3 * q + 1),
                      }),
                      d.isAttacking && (n.src = d.PicArr[d.NormalGif]),
                      oZ.moveTo(k, h, q))
          ...
          OrnIZombies = (function () {
            var a = function (f, b) {
              ...
              (d = f.OrnHP -= b) < 1 &&
                ...
                (f.EleBody.src =
                  f.PicArr[
                    [(f.NormalGif = f.OrnLostNormalGif), (f.AttackGif = f.OrnLostAttackGif)][
                      f.isAttacking
                    ]
                  ]),
                (f.PlayNormalballAudio = e.PlayNormalballAudio),
          ...
          oSmallZombie = InheritO(oZombie, {
            ...
            Init: function (e, g, c, b) {
              var a = 0,
                ...
                d = [];
              g.AttackedRX =
                (g.X = (g.ZX = g.AttackedLX = e) - g.beAttackedPointL) + g.beAttackedPointR;
              while (--b) {
                g.CanPass(b, c[b]) && (d[a++] = b);
              }
              g.ArR = d;
                ...
                function (m, j, i, l, q) {
                  ...
                  h &&
                    ((k = $P[j]) && k.Stature > 0
                      ? ((h.AttackedRX =
                          (h.X =
                            (h.AttackedLX = h.ZX = r = k.AttackedRX) - (h.beAttackedPointL = 45)) +
                          (h.beAttackedPointR = 100)),
                        SetStyle(i, {
                          left: h.X + 'px',
                        }),
...
oDiggerZombie = InheritO(OrnNoneZombies, {
  ...
  Stone_of_Sinan_Up: function () {
    ...
    if (g.isUp) {
      g.EleBody.src =
        g.PicArr[g.isAttacking ? (g.AttackGif = g.AttackGif_Up1) : (g.NormalGif = g.WalkGif2)];
    } else {
      g.Go_Up(g, 0);
    }
