          ...
          function (m, n, l, k, i, j) {
            j(oZ.getRangeLeftZ(m, n, l), 6, i) &&
              ((k -= 5) < -15
                ? ClearChild(i)
                : ((i.style.top = k + 'px'),
                  oSym.addTask(1, arguments.callee, [m, n, GetR(k + 15), k, i, j])));
          },
          [
            d,
            e,
          ...
          function (h, l, j, e, p, k, o, m, q, i) {
            ...
            f && f.Altitude == 1
              ...
              : (p += n = !e ? 5 : -5) < oS.W && p > 100
                ? ((l.style.left = (q += n) + 'px'),
                  oSym.addTask(1, arguments.callee, [h, l, j, e, p, k, o, m, q, i]))
                : ClearChild(l);
          },
      ...
      for (b in c) {
        ...
        f.BulletEle.push(
          NewImg(
            0,
            'images/Plants/PB00.gif',
            'left:' + d + 'px;top:' + (GetY(b) - 50) + 'px;visibility:hidden;z-index:' + (3 * b + 2)
          )
        );
      }
    },
            ...
            function (i, m, k, f, q, l, p, n, r, j) {
              ...
              g && g.Altitude == 1
                ? (g[
                  ...
                  (SetStyle(m, {
                    left: r + 28 + 'px',
                  }).src = ['images/Plants/PeaBulletHit.gif', 'images/Plants/FireBulletHit.webp'][
                    m
                  ]),
                  oSym.addTask(10, ClearChild, [m]))
                : (q += o = !f ? 5 : -5) < oS.W && q > 100
                  ? ((m.style.left = (r += o) + 'px'),
                    oSym.addTask(1, arguments.callee, [i, m, k, f, q, l, p, n, r, j]))
                  : ClearChild(m);
            },
...
*/ // same thing here
    ...
    getHurt: function (e, c, b) {
      ...
      switch (true) {
        ...
        case d.HP < 1334:
          d.HurtStatus < 2 &&
            ((d.HurtStatus = 2),
            (a.childNodes[1].src = 'images/Plants/PumpkinHead/Pumpkin_damage2.gif'));
          break;
        case d.HP < 2667:
          d.HurtStatus < 1 &&
            ((d.HurtStatus = 1),
      ...
      !a &&
        oSym.addTask(
          ...
          function (d) {
            var c = $P[d];
            c &&
              (($(d).childNodes[1].src = 'images/Plants/PotatoMine/PotatoMine.gif'),
              (c.Status = 1),
              (c.canTrigger = 1),
    ...
    getHurt: function (e, b, a) {
      ...
      !(b % 3)
        ? (c.HP -= a) < 1
          ...
          : c.HP < 1334
            ? c.HurtStatus < 2 &&
              ((c.HurtStatus = 2), (d.src = 'images/Plants/WallNut/Wallnut_cracked2.webp'))
            : c.HP < 2667 &&
              c.HurtStatus < 1 &&
              ((c.HurtStatus = 1), (d.src = 'images/Plants/WallNut/Wallnut_cracked1.webp'))
        : c.Die(1);
    },
  }),
    ...
    getHurt: function (e, b, a) {
      ...
      !(b % 3)
        ? (c.HP -= a) < 1
          ...
          : c.HP < 1334
            ? c.HurtStatus < 2 &&
              ((c.HurtStatus = 2), (d.src = 'images/Card/Plants/BalloonGoober.png'))
            : c.HP < 2667 &&
              c.HurtStatus < 1 &&
              ((c.HurtStatus = 1), (d.src = 'images/Zombies/Balloon/popped.png'))
        : c.Die(1);
    },
  }),
    ...
    NormalAttack(zid, fu) {
      ...
      if (fu) {
        oSym.addTask(
          120,
          (_) =>
            $P[self.id] && (ele.childNodes[1].src = self.PicArr[self.NormalGif] + '?' + this.id)
        );
      }
      oSym.addTask(85, (_) => {
      ...
      !(b % 3)
        ? (c.HP -= a) < 1
          ...
          : c.HP < 1334
            ...
            : c.HP < 2667 &&
              c.HurtStatus < 1 &&
              ((c.HurtStatus = 1), (d.src = 'images/Plants/Ling/Ling.gif'))
        : c.Die(1);
    },
  }),
    ...
    getHurt: function (e, b, a) {
      ...
      !(b % 3)
        ? (c.HP -= a) < 1
          ...
          : c.HP < 2667
            ? c.HurtStatus < 2 &&
              ((c.HurtStatus = 2), (d.src = 'images/Plants/TallNut/TallnutCracked2.gif'))
            : c.HP < 5333 &&
              c.HurtStatus < 1 &&
      ...
      !(b % 3)
        ? (c.HP -= 20) < 1
          ...
          : (e.ChangeR({
            ...
            c.HP < 134
              ? c.HurtStatus < 2 &&
                ((c.HurtStatus = 2), (d.src = 'images/Plants/Garlic/Garlic_body3.gif'))
              : c.HP < 267 &&
                c.HurtStatus < 1 &&
  ...
  oSquash = InheritO(CPlants, {
    ...
    getHurt: function (d, b, a) {
      var c = this;
      b != 3
        ? c.NormalAttack(c, d.id, d.ZX + d.Speed * 4 * (!d.WalkDirection ? -1 : 1) - 50)
        : (c.HP -= a) < 1 && c.Die();
    },
    getTriggerRange: function (a, b, c) {
      return [[b - 50, c + 80, 0]];
                    ...
                    ? ($(e).childNodes[1].src = h.getRaven(e)
                        ? (oSym.addTask(
                            ...
                            function (i) {
                              ...
                              j &&
                                ((j.canTrigger = 1),
                                ($(i).childNodes[1].src = 'images/Plants/Chomper/Chomper.gif'));
                            },
                            [e]
                          ),
                          'images/Plants/Chomper/ChomperDigest.gif')
...
*/
    NormalAttack: function (a, b) {
      $(a).childNodes[1].src =
        'images/Plants/BigChomper/ChomperAttack.gif' + $Random + Math.random();
      oSym.addTask(
        70,
        function (c, d) {
          PlayAudio('bigchomp');
                    ...
                    ? ($(e).childNodes[1].src = h.getRaven(e)
                        ? (oSym.addTask(
                            ...
                            function (i) {
                              ...
                              j &&
                                ((j.canTrigger = 1),
                                ($(i).childNodes[1].src = 'images/Plants/BigChomper/Chomper.gif'));
                            },
                            [e]
                          ),
                          'images/Plants/BigChomper/ChomperDigest.gif')
    ...
    NormalAttack: function () {
      ...
      ImgSpriter(
        ...
        function (i, j) {
          var h = $(j);
          $P[j] &&
            ((h.childNodes[1].src = 'images/Plants/FumeShroom/FumeShroom.gif'), SetHidden($(i)));
        }
      );
    },
  }),
    ...
    NormalAttack: function () {
      ...
      ImgSpriter(
        ...
        function (i, j) {
          var h = $(j);
          $P[j] &&
            ((h.childNodes[1].src = 'images/Plants/IcyFumeShroom/FumeShroom.gif'), SetHidden($(i)));
        }
      );
    },
  }),
  ...
  oGloomShroom = InheritO(oFumeShroom, {
    ...
    BirthStyle: function (c, d, b, a) {
      oGd.$[c.R + '_' + c.C + '_1'] &&
        ...
        ((c.canTrigger = 0), (c.Sleep = 1), (b.childNodes[1].src = c.PicArr[3]));
    ...
    TriggerCheck: function (e, c) {
      ...
      e.PZ && Math.abs(e.ZX - b.MX) < 121 && e.beAttacked
        ? (b.ArZ.push(e.id),
          !b.Cry &&
            ((b.Cry = 1),
            ($(a).childNodes[1].src = 'images/Plants/ScaredyShroom/ScaredyShroomCry.gif'),
            b.CryCheck(a)))
        : e.R == b.R &&
          !b.Cry &&
          !b.Attacking &&
        ...
        function (b) {
          ...
          if (d) {
            ...
            f.length
              ? d.CryCheck(b)
              : ((d.Cry = 0),
                ($(b).childNodes[1].src = 'images/Plants/ScaredyShroom/ScaredyShroom.gif'));
          }
        },
        [a]
      );
        ...
        : (oSym.addTask(
          ...
          oSym.addTask(
            ...
            function (f) {
              ...
              e &&
                ((e.Sleep = 0),
                ($(f).childNodes[1].src = 'images/Plants/SunShroom/SunShroom.gif'),
                (e.Status = 1));
            },
            [d]
          ));
  ...
  (oBlover = InheritO(CPlants, {
    ...
    PrivateBirth: function (o) {
      ...
      oSym.addTask(
        ...
        function (id) {
          PlayAudio('blover'),
            ($(id).childNodes[1].src = 'images/Plants/Blover/BloverBlow.gif'),
            $P[id].Dispel();
        },
        [o.id]
      );
    ...
    Dispel: function () {
      ...
      for (z in $Z)
        (oBalloon = $Z[z]), oBalloon.EName == 'oBalloonZombie' && oBalloon.getDispelled(); //把气球吹跑
    ...
    getHurt: function (e, b, a) {
      ...
      !(b % 3)
        ? (c.HP -= a) < 1
          ...
          : c.HP < 2667
            ? c.HurtStatus < 2 &&
              ((c.HurtStatus = 2), (d.src = 'images/Plants/FlamesMushroom/FlamesMushroom2.gif'))
            : c.HP < 5333 &&
              c.HurtStatus < 1 &&
              ((c.HurtStatus = 1), (d.src = 'images/Plants/FlamesMushroom/FlamesMushroom1.gif'))
        : c.Die(1);
    },
    NormalAttack: function () {},
    PrivateBirth: function (a) {
...
oFlowerVase = InheritO(CPlants, {
  ...
  InitImage: function (Kind, XRay) {
    ...
    var selfValue = self.VaseValue || {},
      ...
      VValue =
        selfValue.Value || (VType == 'SunNum' ? 50 : VType == 'Plants' ? oPeashooter : oZombie); // 获取该花瓶的内部玩意
    switch (VType) {
      case 'Plants': // 植物类型
        EleCard.style =
      ...
      case 'Zombie':
        if ($User.Client.Mobile) {
          ...
          if (ZWidth > ZHeight) (EK = ZWidth / MaxW), (ZHeight /= EK), (ZWidth = MaxW);
          // 等比缩放
  ...
  Die: function (ImgSave, OnAudio) {
    ...
    if (OnAudio != false)
      PlayAudio(self.AudioArr[Math.floor(Math.random() * self.AudioArr.length)]); // 随机播放音效
  ...
  PlaceItem: function () {
    ...
    switch (
      ...
      case 'SunNum': // 生成阳光
        if (Value > 500)
          AppearSun(GetX(self.C) - self.width / 2, GetY(self.R) - 30, Value - 500, 0),
            (Value = 500); // 大于五百的阳光直接生成一个大的
        while (Value > 25)
          AppearSun(GetX(self.C) - self.width / 2, GetY(self.R) - 30, 25, 0), (Value -= 25); // 500 以内的，一个一个生成
  ...
  FreshXRay: function (OnlySelf) {
    ...
    if (OnlySelf) {
      ...
      for (var RQ in Arr)
        for (var CQ in Arr) if (Pla[1 * RQ + R + '_' + (1 * CQ + C)]) self.SetXRay(true); // 设置透视
    } else {
      for (var Q in Ground) {
        // 遍历每一个花瓶，如果是花瓶则自我检查
