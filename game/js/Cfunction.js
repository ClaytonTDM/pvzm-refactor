var $User = (function () {
    ...
    e
      ? (document.execCommand('BackgroundImageCache', false, true), (ShadowPNG = ''))
  ...
  oS = {
    ...
    Init: function (e, g, b, d) {
      var c,
        a = window;
      e.LoadMusic
        ? (PlayMusic(e.LoadMusic), NewAudio({ source: 'ChooseYourSeeds', loop: true }))
              ...
              (i < u.FlagNum
                ...
                : (u.FlagToEnd(),
                  $User.isAuthorWebsite &&
                    ...
                    (ClearChild($('JSPVZAjax')),
                    f.SaveLvl && NewEle('JSPVZAjax', 'script', 0, {}, document.body)),
                  f.SaveLvlCallBack &&
                    f.SaveLvlCallBack({
                      UserName: f.UserName,
                      SunNum: oS.SunNum,
  ...
  oGd = {
    ...
    MoveFogLeft: function (a) {
      (function (c, d, b, e) {
        d -= 50;
        d > b
          ? ((c.style.left = d + 'px'), oSym.addTask(5, arguments.callee, [c, d, b, e]))
    ...
    MoveFogRight: function () {
      ...
      (function (a, b) {
        (b += 50) < 901
          ? ((a.style.left = b + 'px'), oSym.addTask(5, arguments.callee, [a, b]))
          : (a.style.left = '900px');
  ...
  GetAP = function (a, h, d, c) {
    ...
    for (
      ...
      g.push((e = i[d + '_' + c + '_' + f++])),
        e &&
          !(a < e.pixelLeft || a > e.pixelRight || h < e.pixelTop || h > e.pixelBottom) &&
          (b = e)
    ) {}
    return [g, b];
  },
...
(ViewProducePlant = function (b) {
  ...
  (ViewProduceZombie = function (b) {
    ...
    $('pHandBookZombie').style.background =
      'url(' + a.PicArr[a.StaticGif] + ') no-repeat scroll ' + a.BookHandPosition;
  ...
  (ViewPlantTitle = function (b) {
    ...
    !oS.CardKind &&
      ...
      !e.CDReady && (a += '<br><span style="color:#F00">recharging</span>'));
...
(AutoProduceSun = function (a) {
  ...
  (AppearSun = function (h, f, e, a) {
    var b,
      d,
      g = 'Sun' + Math.random(),
      c = 'cursor:url(images/interface/Pointer.cur),pointer;z-index:25;left:' + h + 'px;';
    switch (e) {
      case 25:
  ...
  (MoveDropCard = function (c, b, t) {
    ...
    a &&
      ...
      (!a.HasChosen && a.top < b - 52
        ? ((ele.style.top = (a.top += 2) + 'px'), oSym.addTask(5, MoveDropCard, [c, b, t]))
        : DisappearCard(c, t));
  }),
